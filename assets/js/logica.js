    ...
    tareas.forEach((tarea) => {
        ...
        `
            <tr>
                ...
                <td>${tarea.completado ? `<i class="fa-regular fa-circle-check" style="color: #38ff65;" onclick='completar(${tarea.id})'></i>` : `<i class="fa-regular fa-circle" style="color: #38ff65;" onclick='completar(${tarea.id})'></i>` }</td>
